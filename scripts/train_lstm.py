...
def parse_args():
    parser = argparse.ArgumentParser(description="Train temporal LSTM model (single GPU or torchrun DDP).")
    parser.add_argument("--data-root", type=str, default=None)
    parser.add_argument("--epochs", type=int, default=None)
    parser.add_argument("--batch-size", type=int, default=None)
    parser.add_argument("--num-workers", type=int, default=None)
    parser.add_argument("--dry-run", action="store_true", help="Use synthetic sequence data")
    parser.add_argument("--max-steps", type=int, default=None)
    parser.add_argument("--output-dir", type=str, default=None, help="Run root, e.g. outputs/lstm")
    ...
    parser.add_argument("--auto-eval", action="store_true", help="Run temporal evaluation after training on rank0")
...
def main():
    ...
    try:
        ...
        ckpt_path = run_dir / f"lstm_{run_ts}.pth"
        ...
        train_loader, train_sampler = build_train_sequence_loader(
            cfg,
        ...
        if logger is not None:
            ...
            logger.info(
                "model_temporal: hidden=%d layers=%d dropout=%.4f pretrained_backbone=%s head_hidden=%d",
